...
const fadeUp = { hidden: { opacity: 0, y: 40 }, show: { opacity: 1, y: 0, transition: { duration: 0.7, ease: "easeOut" as const } } };
const SUBJECTS_KEYS = ["subjectProject", "subjectCollab", "subjectJob", "subjectOther"] as const;
